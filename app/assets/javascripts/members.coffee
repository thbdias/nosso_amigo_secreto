$(document).on 'turbolinks:load', ->
  # form_for gera um id para os campos de 'name' e email -> #member_name #member_email
  # para confirmar -> inspecionar o elemento no broser e ver  
  $('#member_email, #member_name').keypress (e) ->              # keypress -> se e-mail ou name for pressionado
